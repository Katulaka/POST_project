...
def main(_):
    ...
    parser.add_argument('--min_test', action='append', default=[0], type=int, dest='ds_len_test')
    parser.add_argument('--max_test', action='append', default=[np.inf], type=int, dest='ds_len_test')
